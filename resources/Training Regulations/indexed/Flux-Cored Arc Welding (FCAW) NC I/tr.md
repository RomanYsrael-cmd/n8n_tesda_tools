...
- Source file: `Flux-Cored Arc Welding (FCAW) NC I.pdf`
- SHA-256: `2cc4b09c7c0d8144486ebfc0e140c99846d99827c40fbf81f657f6b8961f1a56`
- PDF pages: 59
- Lifecycle: unclear
...
Page No.
SECTION 1 FCAW NC I QUALIFICATION
1
...
SECTION 1 FLUX-CORED ARC WELDING (FCAW) NC I

The Flux-Cored Arc Welding (FCAW) NC I Qualification consists of competencies
that a person must achieve to weld carbon steel plates components as specified by
layout, blueprints, diagrams, work order, welding procedure or oral instructions using
...
CORE COMPETENCIES
MEE721315
Weld Carbon Steel Plates Using FCAW
...
required in FLUX-CORED ARC WELDING (FCAW) NC I
...
knowledge and
attitudes
2.1. Knowledge of organizational policies/guidelines in
...
2.5.
Knowledge of workgroup member’s responsibilities
and duties
2.6.
...
5.3.
Case studies and scenarios as basis for discussion
...
1.1 One’s unique sense of purpose for working and the
why’s of work are identified, reflected on and clearly
...
knowledge and
attitudes
2.1 Principles of 5S
2.2 Work process and procedures
2.3 Safety signs and symbols
2.4 General OHS principles and legislation
...
implications
The following resources MUST be provided:
4.1 Facilities, materials tools and equipment necessary for
the activity
6. Methods of
 assessment
...
Appropriate protective clothing and devices are
selected and used in accordance with OHS
...
operation of tools and equipment are followed in
accordance with industry/ company policies.
Tools, equipment and materials are handled
safely in accordance with OHS requirements and
industry/ company policies.
4.
Perform first aid
4.1
First aid treatment of injuries is carried out
according to recommended procedures
5.
Use fire extinguisher
5.1
Fire extinguisher is selected and operated
correctly according to the type of fire.
...
2. Protective clothing and
 devices
 Protective clothing and devices may include but are not
 limited to:
...
1.2
Alphabet of lines are identified based on
procedures
...
Simple transposition of formula is carried out to
isolate the variable required, involving the four
fundamental operations.
Where appropriate, formula is constructed to
enable problems to be solved.
Equations involving unknown are solved based
on procedure.
4.
Compute percentage
and ratio
...
2.3 Method of transposing formula
...
standards are identified based on procedure.
...
procedures.
Quality of work is reviewed based on customer
...
Hand tools are selected based on the
...
Task are performed in accordance with company
...
Hand tools are stored in accordance with
manufacturer’s instruction/standard operating
procedure.
...
1. Set up cutting
equipment
1.1 Cutting equipment is set based on acceptable OH&S
standards
1.2 Set up cutting equipment is appropriate for operation
intended.
2. Cut and prepare edge
of materials
2.1 Materials are cut based on specified dimension/
specifications.
...
edges
3.1 Surfaces are cleaned based on required specifications.
3.2 Task is performed in accordance with company or
industry requirements and safety procedure
4. Prepare welding
consumables
...
equipment
5.1 PPE are prepared based on acceptable OH&S
...
1. Critical aspects of
 competency
Assessment requires evidence that the candidate:
1.1 Performed edge preparation in accordance with
...
Assessment may be conducted in the workplace or
...
manufacturer.
1.4 Current, voltage, and wire feed settings is fine-tuned or
adjusted consistent with job requirements
...
and specifications.
2.2
Welding machine accessories and consumables are
set up in accordance with job requirements, welding
procedures and specifications and/or manufacturer’s
instructions.
2.3
Spools are firmly locked to holder, rollers adjusted to
correct tension.
2.4
Purging hoses, dams, flow meter, regulators, torches
and guns are properly installed where needed.
2.5
Gas tanks are properly secured where needed.
3. Set up welding
positioners, jigs and
fixtures
3.1 Braces, stiffeners, rails and other jigs are provided in
...
tools/equipment as
required
4.1 Pre-heating equipment is set up based on job
requirement and specifications
4.2 Equipment is operated in conformance with the
manufacturer’s instructions.
...
1.1 Alternating current (AC) – generally SMAW only
1.2 Direct current (DC)
1.3 Constant current – (SMAW only)
1.4 Constant voltage – (FCAW only)
2. Polarity
...
3.4 gas cylinders and gas heaters
3.5 filters, gas nozzle and insulators
3.6 contact tips
3.7 wire feeders and wire cutter
3.8 cable liners and gas diffusers
4. Gases
4.1 Pure inert gas (argon, etc.)
4.2 Mixed gases
4.3 Pure CO2
...
1.1 Tack welding is performed in accordance with the
requirements of WPS and client’s specifications.
1.2 Tack welding is performed visually and dimensionally
acceptable.
1.3 Backing plate, stiffener, running plate is installed as
required.
...
3. Set up welding
 positioner
3.1 Weld specimen is positioned and secured according to
the requirements.
...
1. Mark/locate weld
defects
1.1 Weld defects are identified according to recommended
practice
1.2 Weld defects are located and marked according to
procedures
3. Prepare tools and
 equipment
2.1 Tools and equipment are prepared based on job
requirements and provision of wind barriers.
2.2 Task is performed in accordance with company or
industry requirements and safety procedure
3. Remove defects
3.1 Weld defects are removed/excavated in accordance with
 approved industry procedures or client requirements.
3.2 Removal of non-defective welds is minimized and
 cleaned.
3.3 Visual and dye-penetrant test is performed to verify the
...
4.1 Re-welding is performed in accordance with approved
 repair procedure.
4.2 Task is performed in accordance with company or
 industry requirement and safety procedure
4.3 Re-welding is performed with no new weld defects or
damages occurred
...
Commented [Mf1]: /tungsten inclusion - deleted
...
:
This unit covers the skills, knowledge and attitudes
 required in welding carbon steel plates using FCAW
 process
.
ELEMENTS
PERFORMANCE CRITERIA
...
1.3 Weld is visually acceptable in accordance with
applicable codes and standards
2. Clean root pass
2.1 Root pass is cleaned is free from defects and
...
3.1 Subsequent/ filling passes is performed in accordance
with approved WPS
...
1.6 Current setting (polarity, amperage, voltage)
 1.7 Backing material (weld metal, backing plate and
 ceramics)
...
2.3 Arc Strike
2.4 Spatters
2.5 Wire and solid material inclusion
...
competency
Assessment requires evidence that the candidate
welded carbon steel plates using FCAW process in
2G and 3G positions to acceptable standards
following the approved WPS.
2. Underpinning knowledge
2.1 Drawing/Plan/WPS interpretation
2.2 Materials and consumables
 2.2.1 Flux-cored electrode (self-shielded/gas
 shielded)
 2.2.2 Shielding gases
2.3 Welding Equipment and Tools
2.4 FCAW welding accessories
2.5 Basic Mathematics (MDAS)
2.6 Welding Codes (symbols)
2.7 Interpretation of weld defects and FCAW
 equipment malfunctions
3. Underpinning skills
3.1 Measuring skills
3.2 Communication skills
3.3 Applying weld technique using FCAW process
3.4 Rectifying weld defects
3.5 Handling welding tools and equipment
3.6 Handling materials and consumables and
 checking purity of shielding gas
4. Resource implications
The following resources must be provided:
4.1 FCAW facilities and equipment
4.2 Supplies and materials
4.3 Fumes extractor
4.4 PPE
4.5 Relevant documentation such as WPS and
 working drawing
4.6 Stand-by fire fighting equipment
5. Method of assessment
Competency must be assessed through:
5.1 Observation and questioning
5.2 Demonstration and questioning
5.3 Written test
5.4 Portfolio (work records, certificates, awards,
 endorsements, etc…)
6. Context of assessment
Assessment may be conducted in the workplace or
in a simulated environment.
...
when designing training programs for FLUX CORED ARC WELDING (FCAW) NCl.

3.1 CURRICULUM DESIGN

Course Title: FLUX CORED ARC WELDING
...
Suggested Nominal Training Hours: 28 hrs. ( Basic Competencies)
 ...
 72 hrs. ( Core Competencies)

Course Description:

This course is designed to enhance the knowledge, skills and attitudes in Flux
Cored Arc Welding NCl in accordance with industry standards. It covers core
competencies such as Welding Carbon Steel Plates Using FCAW.
...
1.1 Perform single pass fillet
 weld in different positions
 (1F-4F)
1.2 Perform multiple pass
 fillet weld in different
 positions (1F-4F)
1.3 Perform multiple pass
groove weld in different
positions (1G-3G)
• Lecturette
• Demonstration
...
the trainee is allowed to progress at his own pace. The trainer just facilitates the
training delivery.
...
•
completed training in SMAW NC I or holder of SMAW NC I
•
...
Recommended list of tools and materials per trainee for FLUX CORED ARC
WELDING - NC I
...
Fcaw nc i 53
 091605
3.6 TRAINERS QUALIFICATIONS FOR FCAW WELDER

FLUX CORED ARC WELDING - NC I

TRAINER QUALIFICATION (TQ I)

• Must be a holder of FCAW NC I
...
achievement of units of competencies. A certificate of achievement is issued for
...
4.1
To attain the National Qualification of FCAW NC I, the candidate must
...
4.2
Assessment shall focus on the core units of competency, weld carbon steel
plates using FCAW. The basic and common units shall be integrated or assessed
...
The Technical Education and Skills Development Project
