...
- Source file: `Flux-Cored Arc Welding (FCAW) NC II.pdf`
- SHA-256: `ee1f5ec96155a04c2ed0e2db9bcd53e1df2dea41c5edefa25ef646d142c3b9cb`
- PDF pages: 59
- Lifecycle: unclear
...
SECTION 1 FCAW NC II QUALIFICATION
1
...
SECTION 1 FLUX-CORED ARC WELDING (FCAW) NC II

The Flux-Cored Arc Welding (FCAW) NC II Qualification consists of
...
instructions using FCAW welding equipment.
...
3.2 Workplace data are recorded on standard workplace
forms and documents
...
are used and interactions are undertaken with team
...
correctly according to the types of fire.
...
Tasks are performed in accordance with company
...
instructions.
2.2 Spools firmly locked to holder, rollers adjusted to correct
tension.
2.3 Purging hoses, damps, flow meter, regulators, torches
and guns are properly installed where needed.
2.4 Gas tanks properly secured where needed.
3. Set up welding
...
1. Mark/locate weld
defects
1.1 Weld defects are identified according to
...
4.3 Re-welding is performed with no new weld defects or
 damages occurred
4.4 Weld is visually checked after re-welding for
 acceptability
...
codes and standards
2. Clean root pass
2.1 Root pass is cleaned and is free from defects and
...
3.1 Subsequent/ filling passes are performed in accordance
with approved WPS
...
Competency
Assessment requires evidence that the candidate
welded carbon steel pipes using FCAW in 2G, 5G
...
2.2 Materials and consumables
 2.2.1 Flux cored electrode (self-shielded and
 gas shielded)
...
3.7 Philippine OH&S Rules and/or client’s safety
 procedure
4
Resource Implications
The following resources must be provided:
4.1 Well ventilated work area/shop with FCAW
facilities and equipment
4.2 Supplies and materials
4.3 PPE
4.4 Fumes extractor, if applicable
4.4 Relevant documentation such as WPS and
working drawing
...
Competency must be assessed through:
5.1 Demonstration/ observation and oral
questioning
5.2 Written test
5.3 Portfolio (awards, records, certificates,
endorsements, etc.)
6
...
Flux Cored Arc Welding NCll in accordance with industry standards. It covers core
competencies such as Setting-up Welding Equipment, Preparing Weld Materials,
Fitting up Weld Materials, Welding Carbon Steel Plates Using FCAW, Welding
Carbon Steel Plates and Pipes Using FCAW and Repairing Welds.
...
using
FCAW
1.1 Perform groove weld on
pipe in different positions
• 2G
• 5G
• 6G
