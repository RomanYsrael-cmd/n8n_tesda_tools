...
- Source file: `Superseded/Heavy Equipment Operation (Crawler Crane) NC II (Superseded).pdf`
- SHA-256: `acb2850343450509637a2fedea1ff7a26b4314c4d1fa50bddc7d2e02986fe110`
- PDF pages: 79
...
SECTION 1 HEAVY-EQUIPMENT OPERATION (CRAWLER CRANE) NC II

The HEAVY-EQUIPMENT OPERATION (CRAWLER CRANE) NC II
qualification consists of competencies that workers must achieve to enable them
to perform tasks such lifting and transferring of heavy loads in construction sites
or other locations.
...
CORE COMPETENCIES
CON833309
Perform pre- and post-operation procedures for lifting
equipment
CON833310
...
required in HEAVY EQUIPMENT OPERATION - CRAWLER CRANE. These
...
3.4. Contribute to the development of teamwork plans
...
2.1.1 Four fundamental operation
...
assessment
Competency should be assessed through:
5.1 Direct observation/Demonstration
5.2 Written test/Oral questioning relevant to
...
CON833309
UNIT DESCRIPTOR:
This unit involves knowledge, skills and attitudes in
...
1.1 Lifting equipment is selected based on job
requirements.
...
procedures
4.1 Equipment is parked and turned off after
productive operation in accordance with
...
3.1 Air cleaner
3.2 Battery terminals/Connection/Clamp/Case
3.3 Belt/Lifting Chain
...
Assessment requires evidence that the candidate:
1.1 Demonstrates ability to select equipment based on the job
 requirements
...
4.1 Appropriate work area for lifting equipment operation
4.2 Access to lifting equipment and manuals.
5. Method of
assessment
...
CON833310
UNIT DESCRIPTOR:
This unit involves the knowledge, skills and
...
manufacturer’s recommendations and/or site
requirements/ conditions.
3. Prepare equipment reports

3.1 Daily checklist form is accomplished in
...
4.1 Equipment supervisor/Foreman
4.2 Chief mechanic
...
servicing
May include but are not limited to:
9.1 Check battery clamps
9.2 Check fan belt conditions (cracked or worn-out)
...
1.2 Demonstrates ability to identify minor defects with checklist
...
1.7 Demonstrates ability to accomplished and submit daily
...
2.3 Safety (PPE, machine and environmental)
...
2.8 Uses of basic hand tools and equipment
3. Underpinning
skills
...
3.4 Reporting minor and major defects
4. Resource
implications

Things necessary for the conduct of assessment
4.1 Access to lifting equipment specifications and manuals
...
standard
operating
procedures for a Crawler Crane.

ELEMENT
PERFORMANCE CRITERIA
Bold and Italicized terms are elaborated in the
Range of Variables
1. Load/unload crane to low-
bed trailer

1.1 Appropriate and suitable low-bed trailer for
transporting the Crane is considered according
to job requirements.
1.2 Proper boom position is observed during
loading/unloading in accordance with safe
operating procedures.
1.3 Crane is loaded/unloaded in correct position
using appropriate ramp.
1.4 Assistance from a signalman is required
during loading/unloading of the crane.
1.5 Before and after loading, all safety locks and
control levers are secured at neutral position.
1.6 Track pads are secured with stopper blocks.
1.7 Body frame is secured with appropriate
binders.
1.8 Unexpected situations are responded in line
with company rules and regulations in a
manner that minimizes risk to personnel and
 equipment.
2. Travel the crane

2.1 Work area is surveyed for safe accessibility or
 potential hazards in accordance with safe
 operating procedures.
2.2 Lattice base boom is secured in place during
travel.
2.3 Aid of a signalman is required when necessary.
2.4 Traveling speed is observed in accordance
 with the site regulations.
2.5 Unexpected situations are responded to in
 line with company rules and regulations.

--- PDF PAGE 56 ---
TR HEAVY EQUIPMENT OPERATION Promulgated December 2004/July 2007

3. Position the crane

3.1 Crane is positioned in accordance
 with safety procedures and requirements
4. Read and interpret load
chart

4.1 Weight of the load is determined according to
 proper information.
4.2 Lifting capacity is determined according to
 working radius and boom length.
4.3 Rigging gears are determined according to
 lifting plan.
4.4 Weight of any attachment such as main and
 auxiliary hook blocks, fly jib are considered as
 part of the load.
4.5 Lifting capacity in the load chart is followed
 according to manufacturer’s specifications and
 equipment conditions.
4.6 Doubt about the lifting capacity of the crane
 based on load chart reading is reported to
 immediate supervisor.
5. Perform lifting and
transferring of load

5.1 Optimum engine speed and allowable working
radius during hoisting or swing operation are
controlled based on standard operating
procedures.
5.2 Communication with Rigger is established and
maintained during lifting and transferring of
loads.
5.3 Safe work procedures and practices are
 observed during lifting and transferring
 operation
5.4 Unexpected situations are responded to in line
...
2.4 Sudden failure of drum brake/clutch (main and auxiliary)
2.5 Sudden malfunction of control levers
2.6 Sudden structural failure of the boom
2.7 Sudden derail of track link assembly
2.8 Sudden tipping
2.9 Sudden ground failure
2.10 Hitting high tension wire
2.11 Force majeure e.g., earthquake, fire, tornado
2.12 Operator fatigue or sickness/condition
2.13 Accidents/incidents
3. Potential hazards
...
3.4 Sloping ground
3.5 Uneven terrain
3.6 Overhead “live” electrical wires
...
procedures and
requirements
4.1 Crane boom and accessories are assembled according
 to job requirements.
4.2 Assembled components and accessories are tested
 according to equipment performance criteria.
4.3 Lifting Plan is thoroughly checked in accordance with job
 requirements
4.4 Load chart is read/interpreted in accordance with lifting
 configuration.
4.5 Work area is barricaded with appropriate informative
 warning signages.
4.6 Crane is positioned on a level and stable working ground
 in accordance with safe lifting requirements.
4.7 Appropriate crane mats are properly in place accordance
 with safety requirements.
4.8 Usable headroom for proper sling selection is determined
 to ensure safe operation.
4.9 Appropriate number of partline is reeved to ensure safe
 working load.
4.10 Trial lift without load is performed to ensure safe lifting
 operation.
4.11 Communicated with rigger to ensure load is secured with
 appropriate rigging gears
4.12 Risk control procedure is implemented in case of adverse
 environmental conditions.
4.13 Unexpected situations are responded in line with
 company rules and regulations.
4.1 Crane boom
and
accessories
4.1.1 Gantry
4.1.2 Counter weights
4.1.3 Insert boom segment
4.1.4 Top boom
4.1.5 Jib (if necessary)
4.1.6 Pendant cables
4.1.7 Main and auxiliary cable
4.1.8 Pulley block
4.1.9 Auxiliary block
4.1.10 Boom pin/cotter pin
4.1.11 Base boom
4.2 Lifting plan
4.2.1 Set-up
4.2.2 Load information
4.2.3 Crane configuration/specification
...
4.3.1 Steel plates
4.3.2 Hardwood
4.3.3 Concrete blocks
4.4 Adverse
environmen-
tal conditions
4.4.1 Fog
4.4.2 Darkness
4.4.3 High-tension wires
4.4.4 Restricted areas
4.4.5 Heavy rains
4.4.6 Wind aloft (exceeding wind velocity of 20 mph)
4.4.7 Unstable ground condition
4.4.8 Congested areas
5. Weight
5.1 Gross capacity
5.2 Net capacity
6. Proper
information
6.1 Bill of ladings
6.2 Packing and shipping list
6.3 Manufacturer’s load specifications
7. Rigging gears
7.1 Types and classifications
7.2 Weight
7.3 Proper hitching or application
8. Lifting capacity
8.1 Obsolescence (expected life span)
8.2 Equipment history
8.3 Machine performance
8.4 Wear and tear
8.5 Structural reliability vs. tipping stability
9. Safe work
procedures
9.1 Lifting/Rigging gears are checked in accordance with job
 requirements.
9.2 All slings, ties and hooks are placed and secured correctly
 before raising the load.
9.3 Load striking the ground, machine or any other object is
 prevented.
9.4 The boom is prevented from striking any obstruction.
9.5 Shock/Dynamic loading is avoided.
9.6 Load handling is observed.
...
transferring
operation
10.1 Release house lock
10.2 Release swing lock
10.3 Monitor safety devices
10.4 Hoist the load
10.5 Swing the load
10.6 Raise and lower the boom
...
Assessment requires evidence that the candidate:
1.1 Demonstrates ability to operate Crawler Crane in
accordance with established operating procedure
1.2 Demonstrates ability to carry-out safe work practices
1.3 Demonstrates ability to interpret Load Chart, Lifting/Rigging
 plan
1.4 Demonstrates ability to communicate with Rigger during
 crane operation
1.5 Demonstrates ability to follow procedures in lifting and
 transporting loads.
1.6 Demonstrates knowledge of basic calculation and
 mensuration
1.7 Demonstrates ability to carry-out safe travel operation
2. Underpinning
(related)
knowledge and
attitude

2.1 Safe operating procedures and practices
2.2 Statutory safety rules and regulations
2.3 Comprehension of load charts
2.4 Comprehension of Lifting/Rigging Plans/site plan and layout
2.5 Company/in-house policies and procedures
2.6 Familiarity with type and center of gravity/weight of loads
2.7 Familiarity with rigging gears and its applications
2.8 Familiarity with rigging signals (ISO standard)
2.9 Basic calculations and mensuration
2.10 Familiarity with safe procedures in assembling and
 dismantling lattice boom
2.11 Familiarity with DOLE/BWC, D.O. 13, series 1998.
3. Underpinning
skills

3.1 Accomplishing crane checklist and reports
3.2 Reporting crane component failure
3.3 Performing actual operation procedure of crane
3.4 Performing safety procedures and practices
3.5 Determining weight and center of gravity
3.6 Following load chart applications
3.7 Using/Following correct rigging signals (ISO standard)
3.8 Calculation and mensuration skills
4. Resource
implications

Things necessary for the conduct of assessment
4.1 Access to Crawler Crane and job site/terrain
4.2 Available loads
4.3 Barricades and informative signages
4.4 Rigging gears
...
Course Title : HEAVY EQUIPMENT OPERATION - CRAWLER CRANE
NC Level:
...
Course Title
: HEAVY EQUIPMENT OPERATION Level:
...
and skills in the use of crawler crane in accordance with industry standards. It
covers core competencies such as: perform pre- and post operation procedure,
perform productive operation, and perform basic preventive maintenance
servicing on a given crawler crane.
...
post-operation
 procedure for
Crawler Crane
2.1 Identify crawler crane
components / parts
2.2 Perform visual check of
equipment
2.3 Check BLOWAF of
crawler crane
2.3.1 Battery
...
2.3.5 Air
2.3.6 Fuel
2.4 Check crawler crane
system’s operation
2.5 Check safety devices
accessories
2.6 Perform post operation
check
Lecture
Practical /
Demonstration
...
2.2 Identify different
 crane signals
2.3 Load and unload
 crawler crane to and
 from trailer bed
2.4 Travel crawler crane
2.5 Position the crane
2.6 Apply interpreted
 crawler cranes load to
 load chart
2.7 Perform crawler
 crane lifting and
 transferring of load
...
stated. Passing written entrance examinations may also be indicated if
necessary.
...
trainees for the operation of crawler crane.
...
The crawler crane operation workshop must be of concrete
...
• Must be a holder of Heavy Equipment Operation (Crawler Crane)
...
(Crawler Crane) NC II, the candidate must demonstrate competence in all
the units of competency listed in Section 1. The successful candidate shall
be awarded a National Certificate signed by the TESDA Director General.

4.2
The qualification of HEAVY EQUIPMENT OPERATION (Crawler Crane)
NC II may be attained through demonstration of competence in a project-
type assessment covering the following core units. Candidates may apply
for assessment in any accredited assessment center.

4.2.1 Crawler Crane operation
...
the Implementation of the Philippine TVET Qualification and Certification System
(PTQCS)."
...
1. Attachment
Refers to anything like clampshell, dragline, boring/rotary (drilling)
equipment, pile driver, drop hammer or other accessories/special
attachments used instead of the conventional lift block to perform
different types of lifting jobs.
2. Boom (crane)
Refers to lattice type of boom or jib used for supporting the
hoisting tackle.
3. Boom Length
Refers to the measurement from the boom foot pins to the center
of the boom point sheaves.
4. Lattice Boom
Refers to a movable mechanical part of the crane carrying the
hoisting gear; it is made up of a network of crisscrossed strips of
metal
5. Reeving
...
superstructure with power plant operating machinery, and lattice
boom mounted on a base, equipped with thread (track assembly)
for travel. In addition to its primary use for lifting services, it is
designed also for duty cycle operations such as dragline,
clampshell and magnet operations. It is normally controlled by a
system of brakes, clutches, and torque converters. This
equipment is classified based on 75 percent of its tipping
capacity.
7. Standard
...
Crane - lifting on outriggers are based on 85 percent of the tipping
capacity).
9. Safety Devices
...
barricaded off and only those directly involve in the lift shall be
allowed to entry.
