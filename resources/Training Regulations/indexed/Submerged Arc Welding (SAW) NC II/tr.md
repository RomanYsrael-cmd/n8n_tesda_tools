...
- Source file: `Submerged Arc Welding (SAW) NC II.pdf`
- SHA-256: `a248668e1a07f4ac66531af1f14a0757e0ec20d9df6aa44b3ecab0b61f5bb7ad`
- PDF pages: 58
- Lifecycle: unclear
...
SECTION 1 SUBMERGED ARC WELDING (SAW) NC II
QUALIFICATION
1
...
The Submerged Arc Welding (SAW) NC II Qualification consists of
competencies that a person must achieve to weld pipe components as specified by
...
1.1.1 1G rotated
1.2 Wall thickness
 1.2.1 12mm (1/2”) and above
1.3 Type of material
1.3.1 Carbon steel
1.3.2 Backing materials (weld metal, ring and
 ceramics)
1.3.3 Types of fluxes
1.4 Type and size of electrode wire
1.5 Travel speed
1.5.1 Current setting (polarity, amperage, voltage)
1.5.2 Preheating requirement (optional)
...
3.3 Setting up and operating SAW equipment and
 accessories
...
Suggested Nominal Training Duration: 18 hrs. ( Basic Competencies)

 56 hrs. ( Common Competencies)

 120 hrs. ( Core Competencies)
...
Welding
Equipment
7.1 Explain welding principles and
concepts.
...
9. Repair
 Welds
9.1 Identify causes and prevention
of the different weld defects
...
1. Weld pipes
using SAW
1.1 Perform multiple pass groove
weld in 1G position rotated
...
• completed training in SAW NC I or a holder of SAW NC I
...
Recommended list of tools and materials per trainee for SAW - NC II
...
4.1
To attain the National Qualification of SAW II, the candidate must demonstrate
...
4.2
Assessment shall focus on the core unit of competency, weld pipes using SAW.
