...
- Source file: `Superseded/Shielded Metal Arc Welding (SMAW) NC III (Superseded).pdf`
- SHA-256: `1185ec3adc5d4cde689f62c7bad1cc7e1cbb8e59aad857d4f5e809c5ee85aa7b`
- PDF pages: 64
...
Page No.
SECTION 1 SHIELDED METAL ARC WELDING (SMAW) III
QUALIFICATION
2
...
CORE COMPETENCY
MEE721313
Weld Alloy Steel Plates Using SMAW
...
required in WELDING NC III (SMAW).
...
problem
2.1.
Possible causes are identified based on experience
and the use of problem solving tools / analytical
techniques.
2.2.
...
corrective action
3.1.
All possible options are considered for resolution of
the problem
3.2.
Strengths and weaknesses of possible options are
considered
3.3.
Corrective actions are determined to resolve the
problem and possible future causes
3.4.
Action plans are developed identifying measurable
objectives, resource needs and timelines in
...
explain, sufficient for the identification of fundamental
cause, determining the corrective action and
...
over an extended period of time, or a suitable
...
assessment
6.1.
In all workplace, it may be appropriate to assess this
...
1.2 Mathematical techniques are selected based on the
given problem
2. Apply mathematical
procedure/solution
2.1 Mathematical techniques are applied based on the
problem identified
...
3. Analyze results
3.1 Result of application is reviewed based on expected
and required specifications and outcome
...
UNIT DESCRIPTOR :
 ...
 skills, and attitude required in selecting, sourcing

 and applying appropriate and affordable
...
This unit covers the skills, knowledge and
 attitudes in welding alloy steel plates using
 SMAW process.
...
1.2 Task performed in accordance with company or
industry requirement and safety procedure.
...
3.1 Subsequent/ filling passes performed in accordance
 with approved WPS
3.2 Weld visually checked for defects and repaired, as
 required
3.2 Weld visually acceptable in accordance with applicable
 codes and standards
4. Perform capping
...
1.2 Material thickness
 1.2.1 1.6mm - unlimited plate thickness
1.3 Type of material
 1.3.1 Alloy steel (or mild steel)
...
1. Critical aspects of
competency
Competency to be demonstrated in welding alloy
steel plates in at least 2 positions to acceptable
standard following approved WPS.
2. Underpinning knowledge
...
Suggested Nominal Training Hours: 20 hrs. ( Basic Competencies)

 56 hrs. ( Common Competencies)

44 hrs. ( Core Competencies)
...
core competencies such as Welding Alloy Steel Plates using SMAW.
...
4.2 Determine fundamental causes
of the problem
4.3 Determine corrective action
4.4 Provide recommendation/s to
manager
• Direct
observation
• Simulation/role
...
relevant
technologies
6.1 Study/select appropriate
 technology
6.2 Apply relevant technology
6.1 Maintain/enhance relevant
 technology
• Direct
observation
• Simulation/role
...
Using
SMAW
1.1 Perform multiple pass fillet
 weld in all positions
 ( 1F-4F )
1.2 Perform multiple pass groove
 weld in all positions
 ( 1G-4G )
...
4.1
To attain the National Qualification of Welding NC III (SMAW), the candidate
...
4.2
Assessment shall focus on the core unit of competency, weld alloy steel
