...
- Source file: `Computer Systems Servicing NC II.pdf`
- SHA-256: `42d85dad87d0566b8b965ac0868e0f92e6cbb4c578028eff648db21be421d147`
- PDF pages: 71
- Lifecycle: unclear
...
Section 1. COMPUTER SYSTEMS SERVICING NC II
QUALIFICATION
1
...
appropriate sources
1.2
Effective questioning, active listening and speaking skills are
...
2. Assess own work
2.1. Documentation relative to quality within the company
...
with the workplace’ s standards operating procedures.
3. Engage in quality
improvement
...
5.1
Quality standards may be related but not limited to
the following:
5.1.1. Materials
5.1.2. Hardware
5.1.3. Final product
...
5.1 Materials, software and hardware to be used in a real
...
task to be taken
undertaken
1.1. Requirements of task are determined in accordance
...
Assessment must show that the candidate:
1.2
Selected and used hardware components correctly and
according to the task requirement
1.3
used basic software applications to create new files and
documents
1.4
...
1.6
Used basic functions of a www-browser to locate
information.
2 Underpinning
knowledge
2.1
...
skills
3.1
Reading and comprehension skills required to interpret
...
3.3
Technology skills to use equipment safely including
keyboard skills.
4 Method of
assessment
...
2.1. Types of measuring instruments and their
uses
...
3. Underpinning skills
3.1. Reading skills required to interpret work
instruction
...
2.1. Components, assemblies or objects are
...
PERFORMANCE CRITERIA
Italicized terms are elaborated in the Range of Variables
1. Plan and prepare for tasks to
be undertaken
...
2.1. Appropriate hand tools are checked for proper
...
4.2. Oral questioning
5. Resource Implication
5.1. Tools may include the following but not limited to:
5.1.1. screw drivers
5.1.2. pliers
5.1.3. punches
...
1. Materials
1.1
Materials included the following but not
limited to:
...
1.1. Undertook work safely and according to
workplace and standard procedures
1.2. used appropriate termination/ connection
methods
...
5. Resource implication
5.1. Tools for measuring, cutting, drilling,
...
5.1.3. cutters
6. Context of Assessment
6.1. Assessment may be conducted in the workplace
...
components
1.1
Work instructions are obtained and clarified based on job
...
testing
2.1
Various testing methods are Identified based on types of
electronic components
2.2
Characteristics and appropriateness of testing methods to be
used during development and on completion is determined
2.3
Testing methods are considered/selected in relation to
appropriate testing strategy
2.4
Plan for testing components is developed at specified points
during development and on completion
2.5
Required test & measuring instruments and tools are
prepared and checked in accordance with established
procedures
2.6
Records system is established to document testing results,
including problems and faults
3. Test components
3.1
Testing methods are applied to ensure that products meet
creative, production and technical requirements
3.2
Problems and faults detected by testing are recorded and
remedial steps taken in records system is documented
3.3
Problems and faults detected during testing are resolved in
accordance with agreed project or industry practice
3.4
Evaluate final products against the previously determined
criteria
3.5
Testing process is documented and summarized evaluation
report is submitted to relevant personnel
4. Evaluate the testing
process
4.1
Testing methods that were successful and those that led to
difficulties are identified based on industry standards
4.2
Testing process and records system are evaluated based on
standard procedures
4.3
...
2.1.1 Conversion of Units
2.1.2 Applied Mathematics
2.2
Safety
2.2.1 Work Safety requirements and economy of
materials with durability
2.2.2 Knowledge in 5S application and observation of
required timeframe
2.2.3 Knowledge of proper handling and disposal of
chemicals
2.3
...
2.4.5
Supplying different voltage using variable power
supply
2.4.6
...
2.4.9
Analyzing simple circuit using ohms and power
law
2.4.10 Analyzing series/parallel circuits using ohms and
power law
2.4.11 Describing alternating current circuits
2.4.12 Observing waveform using oscilloscope
2.4.13 generating waveform in various frequency using
function generator
2.4.14 Measuring frequency using oscilloscope
2.4.15 Measuring capacitance using VOM
2.4.16 Describing capacitance and identifying
capacitors
...
Competency may be assessed through two or more of the
following methods:
4.1
Direct observation of application to tasks and questions
...
assessment
6.1
Assessment maybe conducted in the workplace or in a
simulated workplace setting
...
2 Prepare installer
2.1 Portable bootable devices are created in accordance
...
software
4.1 Application software are installed based on software
installation guides, end-user requirements and software
license agreement
4.2 Variation to application software installation is carried
...
documentation
5.1 Devices / systems and/or installation is tested to
...
Method of
assessment
The assessor may select any two of the following assessment methods to
...
Set network
configuration
2.1 Network connectivity of each terminal is checked in
...
point/repeater
configuration
3.1 Client Device systems settings are configured in
accordance with manufacturers’ instructions and end-
user preferences
3.2 Local area network (LAN) port is configured in
...
4.2 Computer networks are checked to ensure safe
operation.
...
10.1
other requirements for fiber optic cable
installation
...
4. Method of
assessment
The assessor may select any two of the following assessment methods
to objectively assess the candidate:
4.1.
Practical Demonstration w/ oral questioning
4.2.
Interview
...
1.1 User folder is created in accordance with
network operating system (NOS) features
1.2 User access level is configured based on NOS
features and established network access
policies/end-user requirements.
1.3 Security check is performed in accordance with
established network access policies/end-user
requirements.

2. Configure network services
2.1. Normal functions of server are checked in
...
confirmed based on user/system requirements
2.4. Operation of network services are checked
...
3.1. Pre-deployment procedures is undertaken
based on enterprise policies and procedures
3.2. Operation and security check are undertaken
based on end-user requirements
3.3. Reports are prepared/completed according to
...
VARIABLE
RANGE
1. Normal functions of server
1.1
no error on boot sequence
1.2
...
proxy server
2.6
file, printer and other resources sharing
...
Reading and writing skills
4. Method of assessment
The assessor may select any two of the following
assessment methods to objectively assess the
candidate:
4.1.
Practical Demonstration w/ oral questioning
...
6. Context of Assessment
6.1.
Assessment may be conducted in the workplace
or in a simulated environment
...
1.1. Maintenance and/or Diagnosis of faults is planned
...
2.2. Normal function of computer systems and networks
are checked in accordance with manufacturer’s
instructions.
2.3. Scheduled/periodic maintenance is performed in
accordance with manufacturer’s requirements.
2.4. Where necessary, needed repairs/replacements are
made in accordance with established procedures.
2.5. Unplanned events or conditions are responded to in
accordance with established procedures

3. Diagnose faults of
computer systems and
networks
3.1. Appropriate personal protective equipment is used
in line with standard procedures.
3.2. Faults or problems in the computer systems and
networks are diagnosed according to requirements
...
4. Rectify/correct defects
in computer systems
and networks
4.1. Appropriate personal protective equipment is used
in line with standard procedures.
4.2. Defective components or parts are replaced or
...
5. Inspect and test the
computer systems and
networks
5.1. Final inspections are undertaken to ensure that the
...
RANGE
1. Tools
Tools for: cutting, shaping, drilling, threading, tapping,
...
procedures
4.1. OH & S guidelines
4.2. Philippine environmental standards
...
2.2 Computer systems maintenance procedures
2.2.1 PC systems
2.2.2 Computer operations
...
3.2 Communication skills needed to interpret and define work
procedures
3.3 Problem solving in emergency situation
3.4 Network Cabling
...
Method of
assessment
The assessor must select two of the following assessment methods to
objectively assess the candidate:
...
Course Title:
COMPUTER SYSTEMS SERVICING NC Level: NC II
Training Hours:
 40 Hours (Basic)
 80 Hours (Common)
160 Hours (CORE)
...
6.3 Test termination/ connection
...
4.1
To attain the National Qualification of Computer Systems Servicing NC II, the
...
4.2
The qualification of Computer Systems Servicing NC II may be attained
through:
4.2.1
...
4.3
For individuals, who already possess National Certificate (NC) or Certificate of
...
ENGR. ALEX S.E. SY - Chairperson
President, CATIA Foundation, Inc.
President, Electronic Industries Association
of the Philippines, Inc. (EIAPI)

MR. VICTOR GRUET - Member
Proprietor, Symphony IT Consulting
Secretary, Electronics Industries Association
of the Philippines, Inc. (EIAPI)

ENGR. EMMANUEL G. GONZALES - Member
Academic Director
INFOTECH

MR. SEVERINO BURGOS - Member
...
ENGR. RONALDO B. RACELIS
Deputy Program Director, Technology
Asian College (formerly ACSAT)

MR. JAY J. CRISOSTOMO
Trainer, Computer Systems
INFOTECH
ENGR. EMMANUEL G. GONZALES
Academic Director
INFOTECH
