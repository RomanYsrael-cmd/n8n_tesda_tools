...
- Source file: `Heavy Equipment Operation (Paver) NC II.pdf`
- SHA-256: `ad753975461f2b7b8daedb4b4f8aeb2f10e184e55e339b03b4213ac38e16c22c`
- PDF pages: 83
- Lifecycle: unclear
...
SECTION 1 HEAVY EQUIPMENT OPERATION - PAVER NC II

The HEAVY EQUIPMENT OPERATION - PAVER NC II qualification
consists of competencies that workers must achieve to enable them to perform
tasks such as to lay asphalt or concrete materials on roads.
...
CORE COMPETENCIES
CON833321
Perform pre- and post-operation procedures for concreting and
asphalting equipment
CON833322
Perform basic preventive maintenance servicing for concreting
...
required in HEAVY EQUIPMENT OPERATION - PAVER NC II. These units of
...
2. Set and meet work
priorities
2.1 Competing demands are prioritized to achieve personal, team
...
1. Identify hazards
and risks
1.1 Safety regulations and workplace safety and hazard control
...
Technical plans, drawings and specifications relevant to the
 activities
5. Methods of
assessment
...
procedures before and after productive operation of concreting
and asphalting equipment.
...
1.1 Concreting and asphalting equipment is selected based on
job volume requirements / job specifications.
1.2 Operator serviceable (OS) parts are checked in accordance
...
2.1 “BLOWAF” check is performed with checklist form and with
...
Pump; and controls and attachments are checked based on
...
drum working components for Transit Mixer are checked as
per manufacturer's operation manual.
...
operation
procedures
4.1 Equipment is parked on firm and level ground after productive
operation in accordance with company rules and regulations.
4.2 Equipment controls are set into neutral position and parking
...
3.1 Air cleaner
3.2 Battery terminals/Connection
3.3 Belt
...
4.1 Engine off
 ...
 Concrete Pump
 4.1.6 Pipelines and accessory condition
...
4.2 Engine on
 ...
 4.2.1 Gauge, alert / warning indicators and controls
...
Concrete Pump and Transit mixer
5.6 Air (intake and exhaust system)
6. Fluid levels

6.1 Battery electrolyte (maintenance type)
6.2 Engine oil
6.3 Hydraulic oil
6.4 Coolant
6.5 Fuel
...
Transit Mixer and Concrete pump
7.2 Equipment maintenance supervisor
...
8.5 Electrical/ switches
 8.5.1 Lights
 8.5.2 Horn

 Concrete Pump and Transit Mixer
 8.5.3 Safety devices
...
implements
Concrete Pump
11.1 Accumulator hydraulic pump
11.2 Drive cylinder
...
checking procedure
Concrete Pump
12.1 Set delivery piston in action by closing the output regulator (if
...
cleaning procedure
Concrete Pump
16.1 Open hopper flap to let out rest of concrete
...
Assessment requires evidence that the candidate:
1.1 Demonstrates ability to select concreting and asphalting
equipment based on the job requirements / specifications
...
2.2 Controls, instruments, indicators, gauges, safety devices,
hydraulic implements and their uses and functions
...
3.1 Performing pre- and post-operation checking procedures of
equipment
...
4.1 Appropriate work area for concreting and asphalting
equipment
...
6.1 Competency shall be assessed in a normal or a simulated work
place environment and in accordance with safe work
procedures.
...
SERVICING FOR CONCRETING AND ASPHALTING
EQUIPMENT
UNIT CODE:
CON833322
UNIT DESCRIPTOR:
...
manual.
2.3 Basic hand tools and equipment are identified and used in
accordance with site requirements.
2.4 Basic preventive maintenance servicing (PMS) is carried
out in accordance with manufacturer’s and/or site
conditions/requirements.
3. Prepare
equipment reports

3.1 Daily checklist form is properly accomplished in accordance
with manufacturer’s/company requirements.
...
Concrete Pump and Transit Mixer
1.4 Defective filler caps (radiator, fuel, hydraulic)
...
Concrete Pump and Transit Mixer
2.2 Poor engine performance (low power, hard starting)
2.3 Poor working hydraulic implement

Transit Mixer and Paver
2.4 Defective electrical system
2.4.1 Charging
2.4.2 Lighting
2.4.3 Starting
...
May include but not limited to:
3.1 Operation equipment maintenance supervisor
...
4.1 Filters
 4.1.1 Air cleaner
 4.1.2 Water fuel separator
4.2 All caps (oil, water, fluid and fuel)

Transit Mixer and Concrete Pump
4.3 Battery distilled water, clamps and holders
4.4 Tire inflation

Concrete Pump and Paver
4.5 Belts
...
servicing (PMS)
May include but not limited to:
7.1 Check / tighten battery clamps / holders
7.2 Adjust belt tension
...
Assessment requires evidence that the candidate:
1.1 Demonstrates ability to identify minor defects using checklist
and service them following company standard operating
procedures
...
2.2 Service procedures for minor defects
2.3 Types and uses of basic hand tools and equipment
2.4 Knowledge of OS parts
...
4.1 Access to concreting and asphalting equipment and the
...
performing productive operation for paver. It includes skills
required to perform loading paver to and unloading it from low-
bed trailer, travel paver and paving operation.
...
1.2 Loading procedures for paver is performed following
recommended safety practices.
1.3 Unexpected situations are responded to in line with
company rules and regulations and in a manner that
minimizes risk to personnel and equipment.

2. Unload paver from
trailer
2.1 Safe work practices are observed.
2.2 Unloading procedures for paver is performed
 following recommended safety practices.
 2.3 Unexpected situations are responded to in line
 with company rules and regulations and in a
 manner that minimizes risk to personnel and
 equipment.
3. Perform paving
operation
3.1 Communication with spotter is established prior
 to laying of ready mixed materials.
3.2 Paving operation is performed following
 established / recommended practices and job
 specifications / requirements.
3.3 Unexpected situations are responded to in line
 with company rules and regulations and in a
 manner that minimizes risk to personnel and
 equipment.
...
1. Safe work
practices
1.1 Observed 3-point system for embarking on and alighting from
 equipment
1.2 Safety awareness at all times
1.3 Wear minimum PPE
1.4 All controls must be set in neutral position and parking brake
 applied before alighting from paver
2. Loading
procedures
2.1 Appropriate attachment height is observed prior to loading of
 paver
2.2 Communication with signalman is established and maintained.
2.3 Proper positioning of Paver on the ramp is observed.
2.4 Paver is loaded to trailer bed
2.5 All safety locks and control levers are secured and set at
 required position.
2.6 Track and chassis/frame are secured with appropriate stopper
 blocks and binders.
3. Unloading
procedures
3.1 Binders, safety locks, pins and stopper blocks are fully
 dismantled and removed prior to unloading operation.
3.2 Controls are checked in line with safety procedure and prior to
 starting/moving the machine.
3.3 Proper engine warm-up is observed in accordance with the
 manufacturer’s standards.
3.4 Operator is properly responding to the directions of authorized
 signalman while performing unloading procedure.
4. Unexpected
situations
May include but not limited to:
...
4.4 Busted hydraulic hose
4.5 Breakdown of work attachment
4.5 Engine breakdown
4.6 Natural calamities e.g., flashfloods, landslide
4.7 Situations arising from poor peace and order conditions
...
5.2 Concrete
6. Paving operation
6.1 Ready mixed materials are laid in accordance with job
 specifications/requirements.
6.2 Required speed is applied during paving operation according to
 standard operating procedures.
6.3 Control panel gauges and instruments are monitored / adjusted
 and/ or re-adjusted during paving operation.
6.4 Communication is maintained with spotter during paving
 operation
7. Specifications/
requirements
7.1 Thickness
...
1.1 Demonstrates ability to perform loading to / unloading operation
from low-bed trailer following safe work procedures.
1.2 Demonstrates ability to perform paving operation.
1.3 Demonstrates understanding of functions of the paver and the
 control panels and instruments.
1.4 Demonstrates knowledge of design mix of asphalt and / or
Concrete.
2. Underpinning
knowledge,
attitudes

2.1 Familiarity with road construction stages/procedures
2.2 Paving procedures and techniques
2.3 Safety procedures and regulations
2.4 Controls, instruments, gauges and their uses
2.5 Basic components, systems and functions
2.6 Comprehension of equipment operation and maintenance
 manual
2.7 Company rules and regulations relevant to Paver operation
2.8 Procedures for travelling Paver
2.9 Familiar with design mix of asphalt and / or concrete
2.10 Positive work values (time and cost conscious, etc.)
3. Underpinning
skills
3.1 Performing standard operating procedures for equipment
3.2 Reading and interpreting operation and maintenance manual
3.3 Performing safety practices and safe operation
3.4 Interpreting/applying eye and hand coordination
3.5 Following company rules and regulations relevant to paver
 operation
4. Resource
implications
The following resources must be provided:
4.1 Access to paver and work site/terrain
4.2 Equipment manuals
4.3 Ready mixed asphalt and / or concrete
4.4 Prime mover and collapsible trailer and / or trailer with pre-
 fabricated ramp
4.5 Dump trucks / Transit mixer
4.6 Paving crew
4.7 Barricades and informative/safety signages
...
5.4 Work record and documents
6. Context for
assessment
6.1 Assessment may be conducted in the work site in accordance
...
EQUIPMENT OPERATION (PAVER) NC II.

 3.1 CURRICULUM DESIGN

Course Title : HEAVY EQUIPMENT OPERATION - PAVER
NC Level: NC II
...
attitudes and skills in the use of paver in accordance with industry standards. It
covers core competencies such as: perform pre- and post operation procedure,
perform equipment operation, perform basic preventive maintenance on a given
paver.
...
trainees for the operation of paver.
...
The paver operation workshop must be of concrete
...
TOTAL AREA
1,113M2
*Equipment maneuvering area near paver location, paver, dump truck or transit
mixer, and trailer truck with collapsible low-bed trailer (MOA)
...
• Must be a holder of Heavy Equipment Operation (Paver) NC II
...
(Paver) NC II, the candidate must demonstrate competence in all the units
of competency in Section 1. The successful candidates shall be awarded a
National Certificate signed by the TESDA Director General.

4.2
The qualification of HEAVY EQUIPMENT OPERATION (Paver) NC II
maybe attained through demonstration of competence in a project-type
assessment covering the following core units.
...
1. Paver
Refers to equipment used to lay concrete or asphalt
materials
2. Ready mixed concrete
and / or asphalt
Refers to pre-mixed concrete or asphalt materials
designed for laying by concrete or asphalt Paver.
3. Tamper
Refers to attachment that provides initial compaction of
ready mixed concrete or asphalt materials as they are laid
by concrete or asphalt Paver.
4. Screed
Refers to the attachment that equally spreads and levels
off ready mixed materials.
5. Auger
Refers to the attachment that distributes ready mixed
concrete from the hopper to the left and right portion of
the Paver.
6. Conveyor
It is the attachment that carries ready mixed asphalt from
feed hopper to the auger.
7. Hopper
An attachment that serves as a receptacle of the asphalt
or concrete mixed dump into the Paver.
