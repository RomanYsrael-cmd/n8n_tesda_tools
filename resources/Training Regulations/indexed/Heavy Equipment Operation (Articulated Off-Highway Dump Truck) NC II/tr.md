...
- Source file: `Heavy Equipment Operation (Articulated Off-Highway Dump Truck) NC II.pdf`
- SHA-256: `8bbd8a339b8a98c5d563f9e004a06ef954124bd7a3070820225615c9d9dc6ee5`
- PDF pages: 75
- Lifecycle: unclear
...
highway dump truck [Articulated]
NC II
TRAINING
REGULATIONS
CONSTRUCTION SECTOR
...
SECTION 1 HEAVY EQUIPMENT OPERATION - OFF-HIGHWAY DUMP
TRUCK (ARTICULATED) NC II

The HEAVY EQUIPMENT OPERATION - OFF-HIGHWAY DUMP TRUCK
(ARTICULATED) NC II qualification consists of competencies that workers must
achieve to enable them to perform tasks such as loading and dumping of earth
materials in the construction, mining sites or other locations.
...
 Off-highway dump truck (articulated) operator
...
(ARTICULATED) NC II. These units of competency are categorized into basic,
...
ground after productive operation in
accordance with safety company rules and
regulations.
...
UNIT TITLE:
PERFORM PRODUCTIVE OPERATION FOR OFF-
HIGHWAY DUMP TRUCK [ARTICULATED]
UNIT CODE:
CON833320
UNIT DESCRIPTOR:
This unit deals with the knowledge, skills and attitude
required for performing productive operation for off-
highway dump truck [articulated]. It covers the skills
required to perform loading, handling and dumping
operations of earth materials.
...
regulations.
1.2 Communication is established with the
loading operator during operation.
1.3 Dump truck is positioned at the loading area
following safe work procedures.
1.4 Required control levers are applied according
to operation's manual
1.5 Engine is set at low idle speed during waiting /
loading operation.
1.6 Allowable load capacity of truck is observed as
per manufacturer’s specifications.
1.7 Unexpected situations are responded in line
 with company rules and regulations.
2. Perform hauling operations
2.1 Site hazards and appropriate safe operating
techniques are identified according to safe
operating practices.
2.2 Safety precautions are observed based on
road conditions.
2.3 Required travel speed is observed according to
work site and load conditions.
2.4 Power Take-Off is disengaged during
operations.
2.5 Unexpected situations are responded in line
with company rules and regulations.
...
3.1 Communication is maintained with the
appropriate personnel during dumping
operation.
3.2 Dumping procedure is performed following
safe work procedures.
3.3 Unexpected situations are responded in line
with company rules and regulations.
...
1. Safe work
practices
1.1 Wear minimum PPE
1.2 Observed firm and flat ground for the loading and dumping area
1.3 Checked for proper illumination of work site
1.4 Observed 3-point contact in embarking on and alighting from
equipment
1.5 All controls must be in neutral position and parking brake
applied during loading / dumping operation
1.6 Observed proper housekeeping
2. Communication
2.1 Hand signal
2.2 Radio
...
3. Loading
operator
3.1 Wheel loader operator
3.2 Excavator /shovel operator
3.3 Clampshell/dragline operator
3.4 Conveyor operator
4. Safe work
procedures
4.1 Loading
 4.1.1 Tractor head is aligned with the dump body
 4.1.2 Park brake is engaged
 4.1.3 Gear shift lever is in neutral / parked position
4.2 Dumping
 4.2.1 Tractor head is aligned with the dump body
 4.2.2 Park brake is applied
 4.2.3 Gear shift lever is in neutral / parked position
5. Control levers
5.1 Parking brake
gear shift
6. Unexpected
situations
May include but are not limited to:
6.1 Sudden engine breakdown
6.2 Busted hydraulic hose and oil leakages
6.3 Sudden loss of brake
6.4 Loss control of steering
6.5 Sudden ground failure
6.6 Force majeure e.g., earthquake, fire, tornado
6.7 Operator fatigue or sickness/condition
6.8 Accidents/incidents
...
May include but are not limited to:
7.1 Landslides
7.2 Flood / Heavy rains
7.3 Excavations
7.4 Darkness or poor visibility
7.5 Uneven/unstable terrain
7.6 Road obstructions
8. Safety
precautions
8.1 Retarder brake
8.2 Differential lock
9. Road conditions
9.1 Downhill
9.2 Uphill
9.3 Muddy
...
10.1 Spotter
10.2 Site foreman
10.3 Site superintendent
11. Dumping
procedure
11.1 Power take-off is engaged
11.2 Control lever is applied prior to dumping
11.3 Dump box is raised in smooth and controlled engine RPM
11.4 Dump body is lowered to normal position before traveling
...
regulations
1.2 Demonstrates ability to operate dump truck in accordance with
established operating procedures.
1.3 Demonstrates ability to carry out safe work practices.
1.4 Demonstrated knowledge of functions of instrument panel
gauges, controls and alert indicators.
1.5 Demonstrates ability to observe allowable load capacity of off-
highway dump truck (articulated).
1.6 Demonstrates ability to observe safe and efficient loading /
hauling / dumping procedures from loading area to dumping
site
...
manual.
2.6 Knowledge of allowable load capacity of dump truck
...
2.10 Quality of materials to be loaded
...
6. Context for
assessment
6.1 Assessment maybe conducted in the work site or in a simulated
venue.
6.2 Competency shall be assessed while work is being undertaken
independently.
...
EQUIPMENT OPERATION (ARTICULATED OFF-HIGHWAY DUMP TRUCK)
NC II.
...
and skills in the use of off-highway dump truck (articulated) in accordance with
industry standards. It covers core competencies such as: perform pre- and post
operation procedure, perform productive operation, and perform basic preventive
maintenance servicing on a given off-highway dump truck (articulated).
...
• Can drive and holder of Professional Drivers license
...
trainees for the operation of off-highway dump truck (articulated).
...
The off-highway dump truck (articulated) operation workshop must be of
...
HEAVY EQUIPMENT OPERATION (ARTICULATED OFF-HIGHWAY
DUMPTRUCK)

TRAINER QUALIFICATION (TQ II)
• Must be a holder of Heavy Equipment Operation (Articulated
...
(Articulated Off-Highway Dump Truck] NC II, the candidate must
demonstrate competence in all the units of competency in Section 1. The
successful candidates shall be awarded a National Certificate signed by the
TESDA Director General.

4.2 The qualification of HEAVY EQUIPMENT OPERATION (Articulated Off-
...
 Perform pre- and post-operation procedure for hauling
equipment
 Perform productive operation for off-highway dump truck
(articulated)
 Perform basic preventive maintenance servicing for hauling
...
1. Off-highway dump Truck
[articulated]
Refers to articulated frame type of dump truck used for
loading and hauling different types of earth materials e.g.,
rocks, limestones, coal, etc.
2. Retarder brake
