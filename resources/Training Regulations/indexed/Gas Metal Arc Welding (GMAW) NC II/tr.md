...
- Source file: `Gas Metal Arc Welding (GMAW) NC II.pdf`
- SHA-256: `b92f3cc8fcc442c78a0af2654087c88082d015cf91e2f660a424b62c875a8bd7`
- PDF pages: 59
- Lifecycle: unclear
...
SECTION 1 GAS METAL ARC WELDING (GMAW) NC II
QUALIFICATION
1
...
The Gas Metal Arc Welding (GMAW) NC II Qualification consists of
competencies that a person must achieve to weld carbon steel pipes components as
specified by layout, blueprints, diagrams, work order, welding procedure or oral
instructions using GMAW welding equipment.
...
units of competency required in Gas Metal Arc Welding (GMAW) NC II.
...
1.2 Set up equipment is appropriate for operation intended
...
1.2 Alloy steel (level III & IV)
1.3 Cutting gases
1.4 Gouging electrodes
1.5 Grinding/cutting discs
1.6 Run on/run off, backing plates/ring
1.7 Cutting accessories
2. Cut
Cut material using
...
instructions.
2.3 Spools firmly locked to holder, rollers adjusted to
correct tension.
2.4 Purging hoses, damps, flow meter, regulators, torches
and guns are properly installed where needed.
2.5 Gas tanks properly secured where needed.
...
Types, kind and uses of GMAW welding machines
1.1 Direct current (DC)
1.2 Constant voltage
2. Polarity
...
3.6 wire feeders and wire cutter
3.7 contact tips
...
3.4 Welding instructor is informed to verify the extent of
defect removal.
...
required in welding carbon steel pipes using GMAW
process.
...
1.2 Weld visually checked for defects and repaired, as
 required
1.3 Weld visually acceptable in accordance with applicable
codes and standards
2. Clean root pass
...
1.3.1
Carbon or mild steel pipes
1.3.2
Diameter 25.4mm (1 inch) and above
...
Competency
Assessment requires evidence that the candidate
welded carbon steel pipes using GMAW process in
2G and 5Gand/or 6G positions to acceptable
standards following the approved WPS.
2
Underpinning Knowledge
2.1 Drawing/Plan/WPS interpretation
2.2 Materials and consumables
2.2.1 Electrode wire
2.2.2 Shielding gases (mixed gases)
2.3 Welding Equipment and Tools
2.3.1 GMAW equipment
2.3.2 GMAW welding accessories
2.4 Basic Mathematics (MDAS)
2.5 Welding Codes (symbols)
2.6 Interpretation of weld defects and GMAW
equipment malfunctions
2.7 Modes of metal transfer
3
Underpinning Skills
3.1 Measuring skills
3.2 Communication skills
3.3 Rectifying weld defects
3.4 Applying welding techniques for GMAW
...
The following resources must be provided:
4.1 GMAW facilities and equipment
4.2 Supplies and materials
4.3 Fumes extractor
4.4 PPE
4.5 Relevant documentation such as WPS and
working drawing
4.6 Stan-by fire fighting equipment
5
Method of Assessment
Competency must assessed through:
5.1 Observation and interview
...
consider when designing training programs for GAS METAL ARC WELDING
(GMAW).
...
Course Title: GAS METAL ARC WELDING
...
Welding Carbon Steel Plates and Pipes Using GMAW.
...
health and
safety
8.1 Evaluate hazard and
risks
8.2 Control hazards and
risks
...
Welding
Equipment
2.1 Explain welding principles
and concepts.
3.1 Identify the parts of welding
machine
4.1 Set up welding machine and
accessories
5.1 Set up welding positioners,
jigs and fixtures
6.1 Set up pre-heating
...
Using
GMAW
1.1 Weld plates in single pass
groove joints in overhead
positions
1.2 Weld pipe in 2G, 5G and 6G
positions
• Lecturette
• Demonstration
...
Trainees or students wishing to gain entry into these course should possess
the following requirements:

•
 completed training in GMAW NC I or a holder of GMAW NC I
•
...
Recommended list of tools and materials per trainee for GAS METAL ARC
WELDING - NC II
...
3.6 TRAINERS QUALIFICATIONS FOR GMAW WELDER

TRAINER QUALIFICATION (TQ II)

• Must be a holder of GMAW Welder NC II
...
4.1
To attain the National Qualification of GMAW II, the candidate must
...
pipes using GMAW. The basic and common units shall be integrated or
