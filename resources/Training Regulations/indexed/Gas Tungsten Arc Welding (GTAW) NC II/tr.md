...
- Source file: `Gas Tungsten Arc Welding (GTAW) NC II.pdf`
- SHA-256: `61e720fdfcbddaa85498a09f41d928ef3a3bd7f69cccb6e79cabd05724bf06c2`
- PDF pages: 62
- Lifecycle: unclear
...
SECTION 1 GAS METAL ARC WELDING (GTAW) NC II
QUALIFICATION
1
...
Types, kind and uses of GTAW welding machines
...
3. Accessories
3.1 tig torches short and long back caps
...
candidate welded carbon steel plates using
...
Competency
Assessment requires evidence that the
candidate welded carbon steel pipes using
...
Using
GTAW
1.1 Explain GTAW welding
principles
1.2 Explain the different
shielding gases and their
uses
1.3 Deposit weld beads on
plates
...
Using
GTAW
2.1 Weld plates in single pass
groove joints in overhead
positions
2.2 Weld pipe in 2G, 5G and
6G positions
• Discussion
• Demonstration
...
4.1
To attain the National Qualification of GTAW II, the candidate must
