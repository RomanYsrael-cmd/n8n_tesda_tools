...
- Source file: `Submerged Arc Welding (SAW) NC I.pdf`
- SHA-256: `043983491b58753422992915ad91dccdf08d5c7e12b946a82ce19971ba382b8e`
- PDF pages: 59
- Lifecycle: unclear
...
SECTION 1 SUBMERGED ARC WELDING (SAW) NC I
QUALIFICATION
2
...
The Submerged Arc Welding (SAW) NC I Qualification consists of
competencies that a person must achieve to weld plate components as specified by
...
required in SUBMERGED ARC WELDING (SAW) NC I
...
instructions.
2.3
Spools firmly locked to holder, rollers adjusted to
correct tension.
2.4
Flux recovery equipment installed where needed.
2.5
Flux oven /heaters installed where needed.
3. Set up welding
...
3.1 contact tips
3.2 nozzle
3.3 wire feeders and wire cutter
3.4 flux recovery equipment
3.5 tractor rollers and rails
...
This unit covers the skills, knowledge and attitudes
 required in setting up and operating automatic
 welding equipment used in welding carbon steel
 plates.
...
1.2 Material thickness
 1.2.1 12.7mm (1/2”) and above
1.3 Type of material
1.3.1 Carbon steel
1.3.2 Backing materials (weld metal, plate or
ceramics)
1.3.3 Types of fluxes
1.4 Type and size of electrode wire
1.5 Travel speed
1.6 Current setting (polarity, amperage, voltage)
1.7 Preheating requirement (optional)
1.8 Welding equipment
1.8.1 Gen-set
1.8.2 Rectifier
1.8.3 Wire feeder
1.8.4 Flux hopper
1.8.5 Run-on/run-off plates
1.8.6 Flux recovery
...
2.3 Arc Strike
2.4 Spatters
2.5 Slag and solid material inclusion
...
competency
Assessment requires evidence that the candidate
set up and operated automatic welding equipment
used in welding carbon steel plates in 1F, 2F and
1G positions to acceptable standard following the
approved WPS.
2. Underpinning Knowledge
...
3.2 Communication skills
3.3 Rectifying weld defects
3.4 Setting weld plates and arc length
3.5 Setting up and operating SAW equipment and
 accessories
3.6 Setting welding parameters (current, voltage
 and travel speed)
3.7 Setting electrode wire feeder
3.8 Flux recovery techniques
3.9 Handling welding tools and equipment
3.10 Handling welding materials and consumables
4. Resource implications
The following resources must be provided:
4.1 SAW facilities and equipment
...
5.3 Written test
5.4 Portfolio assessment (awards, certificates,
 Commen
dations, endorsement, etc.)
6. Context of assessment
Competency to be assessed while a task is being
undertaken in the workplace or in a simulated
workplace setting.
...
consider when designing training programs for SUBMERGED ARC WELDING
(SAW).

3.1 CURRICULUM DESIGN

Course Title: SUBMERGED ARC WELDING
NC Level NC I

Suggested Nominal Training Duration: 28 hrs. ( Basic Competencies)

 56 hrs. ( Common Competencies)

 40 hrs. ( Core Competencies)

Course Description:

This qualification is designed to develop knowledge, desirable attitudes and
skills in setting up and operating automatic welding equipment used in welding
carbon steel plates.
...
1.1 Perform single pass fillet weld
in different positions
 (1F and 2F)
1.2 Perform multiple pass fillet
weld in different positions
 (1F and 2F)
1.3 Perform multiple pass groove
weld in 1G position
...
3.5 LIST OF TOOLS, EQUIPMENT AND MATERIALS

 SUBMERGED ARC WELDING – NC I

Recommended list of tools and materials per trainee for SAW – NC I
...
Flux oven
1 reel
Filler wire 2.4 / 3.2 mm
dia. EL8, EM12, or EH14
...
Note : One(1) reel filler & one(1) bag flux good for 2-3 trainees
...
54
3.6 TRAINER’S QUALIFICATIONS FOR WELDER

SUBMERGED ARC WELDING – NC I
TRAINER QUALIFICATION (TQ I)

•
 Must be a holder of SAW NC I
•
...
4.1
To attain the National Qualification of SAW I, the candidate must demonstrate
...
4.2
Assessment shall focus on the core units of competency, weld plates using
SAW. The basic and common units shall be integrated or assessed
