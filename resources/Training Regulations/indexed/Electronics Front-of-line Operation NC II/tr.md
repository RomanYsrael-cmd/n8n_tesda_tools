...
- Source file: `Electronics Front-of-line Operation NC II.pdf`
- SHA-256: `23cd3c7f6f2786b99a8e2bc7ee99d39f6a951c88074344f32420741b1fed7777`
- PDF pages: 71
- Lifecycle: unclear
...
ELECTRICAL & ELECTRONICS SECTOR
ELECTRONICS FRONT-OF-LINE (FOL) OPERATIONS
...
TR-ELECTRONIC FRONT-OF-LINE OPERATIONS NC II (NEW) Promulgated Dec. 16, 2015
1
TRAINING REGULATIONS FOR
ELECTRONICS FRONT-OF-LINE (FOL) OPERATIONS NC II

Section 1
ELECTRONICS FOL OPERATIONS NC II QUALIFICATIONS

The Electronics Front-of-Line (FOL) Operation s NC II Qualification consists of competencies
that must be possessed to enable a person to work in an electronics company engaged in
production of electronics front-of-line products. This qualification involves such competencies
to set up FOL operations workplace, analyze, carry-out and monitor FOL operations and
check quality compliance of FOL operations for electronics production line.
...
CORE COMPETENCIES
ELC313304
Set up front-of-line (FOL) operations workplace for electronics
production line
ELC313305
Analyze, carry-out and monitor front-of-line (FOL) operations for
electronics production line
ELC313306
Check quality compliance of front-of-line (FOL) operations for
electronics production line

A person who has achieved this Qualification is competent to be:

•
Electronics Front-of-Line Operator
...
competency required for Electronics Front-of-Line (FOL) Operations NC II.
...
finishing, cutting. Tool set includes the following but not
limited to:
1.1 screw drivers,
1.2 pliers,
1.3 punches,
...
3.1. Tools may include the following but not limited to:
3.1.1. screw drivers
3.1.2. pliers
3.1.3. punches
...
3.4. Forms
4. Quality standards
4.1. Quality standards may relate but not limited to the
following:
4.1.1. materials
...
1.5. Maintained computer system in line with the
standard operating procedures
2. Method of assessment
2.1. The assessor may select two of the following
assessment methods to objectively assess the
candidate:
2.1.1. Observation with oral questioning
2.1.2. Practical demonstration
3. Resource implication
...
UNIT OF COMPETENCY: SET UP FRONT-OF-LINE (FOL) OPERATIONS WORKPLACE FOR
ELECTRONICS PRODUCTION LINE

UNIT CODE : ELC313304

UNIT DESCRIPTOR : This unit covers the knowledge, skills and attitudes needed in setting-up the
workplace for electronics for front-of-line (FOL) operations. This includes
gathering production tools and materials, setting up electronics FOL
machine parameters and peripherals, accomplishing electronics FOL
production line checklist and performing daily maintenance activity.
...
production line systems and
processes
• Familiarity with electronics
FOL materials
• Understanding bill of
materials, travelers, check
list and other applicable
electronics FOL documents/
specifications.
• Awareness of safe handling
of tools and materials i.e.
5S, Material Safety Data
Sheet (MSDS), Personal
...
visual inspection of FOL
machine is done prior to
production operations
2.2 Electronics FOL machine
parameters are set
correctly according to
production specifications
2.3 Electronics FOL machine
parameters and
...
• Electronics FOL machine
set up parameters
• Awareness of safety
operation of FOL machines
...
specifications
3.2 Electronics production
line FOL checklist are
correctly filled-out
according to
specifications
3.3 Electronics production
line FOL checklist is
completed based on
required time
...
workplace)
• Understanding the
applicable PM checklist
• Time consciousness
• Awareness on applicable
out of control action plan
(OCAP)
• 5S principles
...
1.2 Insulated Wires
1.3 Chip components
1.4 Discrete components
1.5 Through Hole components
1.6 Solder paste
1.7 Solder wire
1.8 Epoxy/ glue
1.9 Lead frame
...
2.2 Set-up checklist
2.3 Work Instructions (WI)
2.4 Production procedures
2.5 Out of Control Action Plan (OCAP) procedures
2.6 Control Plan procedures
2.7 Statistical Process Control (SPC) procedures
2.8 Work Manual
2.9 Production Process and Flow Diagrams
3.
Hand tools
...
3.4 Calculator
3.5 Torque driver
3.6 Wafer handling tools
3.7 Jigs and fixtures
4.
PPE
Personal protective equipment may include:
4.1 ESD apparel
4.1.1 Shoes
4.1.2 Smock and Head cap
4.1.3 ESD Jacket
4.1.4 Bunny suit
4.1.5 Face mask
4.1.6 Wrist/Foot ground strap
4.1.7 Gloves/ Finger cots
4.2 Safety shoes
4.3 Gloves
4.4 Safety goggles
4.5
...
Electronics front-of-line (FOL) processes may include but
not be limited to:
5.1 Solder application
5.2 Component placement
5.2.1 Automatic
5.2.2 manual
5.3 Solder reflow
5.4 Glue application
5.5 Inspection
5.5.1 Automatic
5.5.2 Manual
6.
...
6.1 Set up/ Change over time
6.2 Production cycle time
6.3 Process cycle time
6.4 Machine Uptime
6.5 Curing time
7.
Documents
...
7.1.1 Lot summary
 ...
 PM checklist
7.1.2 Monitoring checklist
7.1.3 SPC checklist
7.2 Material / Lot traveler
7.3 Work Instruction (WI)
7.4
Set up sheet
8.
Machine parameters
...
9.2
Fixtures
10. Appropriate personnel Appropriate personnel may include:
10.1 Immediate supervisor
10.2 Maintenance personnel
10.3 Engineer
10.4 Quality Control personnel
11. Machine basic
physical conditions
Machine basic physical condition check may include:
11.1 Complete screws
11.2 Fan is working
11.3 No oil leakage
11.4 No broken wire
11.5 Free from foreign materials
11.6 Industrial PC in good condition
11.7 Dust free
11.8 Appropriate peripherals
...
of Competency
Assessment requires evidence that the candidate:
1.1 Gathered production tools and materials for electronics front-
of-line operations according to approved production
specifications
1.2 Checked and set up electronics front-of-line machine
parameters and peripherals for production startup and usage
1.3 Accomplished electronics front-of-line production quality
checklist according to quality manuals and procedures
1.4 Checked machine’s basic physical condition in accordance to
production line standards and performed daily maintenance
activity based on required time
2. Resource
Implications
The following resources MUST be provided:
2.1 Appropriate Electronics FOL machine and equipment
...
3.2 Direct Observation with oral questioning
3.3 Exams and Tests
...
TR-ELECTRONIC FRONT-OF-LINE OPERATIONS NC II (NEW) Promulgated Dec. 16, 2015
33
UNIT OF COMPETENCY: ANALYZE, CARRY-OUT AND MONITOR FRONT-OF-LINE
(FOL) OPERATIONS FOR ELECTRONICS PRODUCTION LINE

UNIT CODE : ELC313305

UNIT DESCRIPTOR : This unit covers the knowledge, skills and attitudes needed in
performing any process, either automated or manual, in front-of-
line (FOL) operation for electronics production line. This includes
operating electronics FOL equipment, running sample units and
loading production units. It also includes performing FOL manual
...
1.4 Electronics FOL machine
settings are checked
according to product
specifications
1.5 Electronics FOL machine is
initialized/operated in
accordance with work
instructions and company
procedures
1.6 Electronics FOL machine’s
troubles/ problems are
immediately recorded and
reported to the appropriate
personnel
• Awareness on safe
working conditions
• Awareness on electronics
FOL machine safety
...
2.1. Safety requirements are
observed and followed using
the operation manual
2.2. Appropriate PPE and ESD
apparels are used in the
performance of the job
2.3. Appropriate tools and
materials are used according
to task requirements
2.4. Electronics FOL manual
processes are performed in
accordance with work
instructions
2.5. Production line issues are
immediately recorded and
reported to the appropriate
personnel
...
3.1. Sample output is checked in
accordance to product
criteria
3.2. Electronics FOL sample unit
is loaded to the equipment in
accordance to product
orientation and specifications
3.3. Out of control action plan
(OCAP) is followed in case of
any non-conformance or
deviation to the process
3.4. Production forms are
...
• Product orientation
• Understanding of OCAP
on running electronics
production line FOL
sample units
• Completeness and
accuracy of information on
production line form FOL
for sample units
• Reading skills
• Observation
Skills
...
4.1 Production output is checked
in accordance to product
criteria
4.2 Production units are loaded to
the equipment in accordance
to product orientation and
specifications
4.3 If applicable, electronics FOL
manual process is performed
in accordance with work
instructions and company
procedures
4.4 Out of control action plan
(OCAP) is followed in case of
any non-conformance or
deviation to the process
4.5 Electronics FOL production
forms are accomplished
based on production
procedures
• Electronics production line
FOL operation process
controls
• Understanding of OCAP
on electronics production
line FOL operation
...
3.1.1 Tweezers
3.1.2 Vacuum Pen
3.1.3 Metric Allen Keys
3.1.4 12 Digit Calculator
3.1.5 Torque driver
3.1.6 Pliers
3.1.7 Glue dispenser
3.2 Materials
3.2.1 Appropriate production components
3.2.2 ESD apparels
4 Electronics production
line FOL machines
Electronics FOL machines may include:
4.1 Solder Re-flow
4.2 Soldering Station
4.3 Dispensing Machine
4.4 Oven
4.5 Pick and Place Machine
4.6 Inspection Machine
5 Electronics FOL
manual processes
...
Assessment requires evidence that the candidate:
1.1
Operated electronics front-of-line machine/ equipment
according to production requirements
1.2
Performed electronics front-of-line manual processes in
accordance with work instructions
1.3
Run electronics front-of-line sample units in accordance to
product orientation and specifications
1.4
Loaded electronics front-of-line production units in
...
The following resources MUST be provided:
2.1
Appropriate electronics FOL machine and equipment
2.2
...
TR-ELECTRONIC FRONT-OF-LINE OPERATIONS NC II (NEW) Promulgated Dec. 16, 2015
37
UNIT OF COMPETENCY: CHECK QUALITY COMPLIANCE OF FRONT-OF-LINE
OPERATIONS FOR ELECTRONICS PRODUCTION LINE

UNIT CODE : ELC313306

UNIT DESCRIPTOR : This unit covers the knowledge, skills and attitudes needed in
performing front-of-line (FOL) operations for electronics production
line. This includes monitoring machine/equipment operation,
completing lot traceability and performing visual machine
inspection for electronics FOL production line.
...
1.1. Output and yield are checked
...
any non-conformance or
deviation to the process
1.3. Electronics FOL production
...
identified and segregated in
accordance with production
procedures
2.4. Housekeeping procedures are
observed in accordance with
5S discipline and established
procedures.
• Finished products
...
Assessment requires evidence that the candidate:
1.1
Monitored electronics front-of-line (FOL) machine/
equipment operation based on product requirements
1.2
Completed electronics FOL lot traceability in accordance
with production procedures
1.3
Performed visual inspection in accordance to electronics
...
when designing training programs for Electronics Front-of-Line (FOL) Operations NC II.
...
Course Title: Electronics FOL Operations
...
Electronics Front-of-Line Operator, in accordance with industry standards. It covers the basic
& common competencies in addition to the core competencies such as preparing workplace,
analyzing, carrying-out and monitoring front-of-line machine/equipment operation and
checking quality compliance for electronics FOL operations.
...
8 hrs
1.1 Gather production
tools and materials
for electronics FOL
operation
• Identify/determine electronics FOL manufacturing
processes
• Understand purpose and background of setup FOL
operation workplace for electronics production line
• Identify and gather required materials, tools and
equipment
...
electronics FOL machine
•
Set up/Check electronics FOL machine parameters
and peripherals
•
Discuss and demonstrate procedures in set up of
electronics FOL machine parameters and
• Lecture
• Discussion
• Demonstratio
n
...
peripherals
•
Study types and functions of electronics FOL
...
checklist
•
Study types of production line documents/
checklists
•
...
maintenance
activity
• Identify and check electronics FOL machine basic
physical condition
...
2.1 Initialize/Operate
electronics FOL
machine/
equipment
•
Learn and apply safety requirements based on the
operation manual
•
Learn and interpret overview of electronics FOL
processes
•
Identify types of electronics FOL sample units
•
Learn and determine product orientation
•
Perform procedure in processing electronics FOL
sample units
•
Perform manual electronics FOL processes
•
Lecture
•
Discussion
...
Duration
•
Identify electronics FOL equipment troubles/
problems
•
Determine machines alarms/errors
•
Identify appropriate PPE and ESD apparels
•
Study and determine applicable out-of-control
action plan(OCAP)
•
...
manual processes
•
Read and understand electronics production line
FOL manual processes
o Solder paste application
o Component placement
o Solder reflow
o Solder application
o Glue application
o Product inspection
•
Learn and apply safety requirements in the
operation manual
•
Identify and use appropriate PPE and ESD
apparels
•
Study and determine applicable out-of-control
action plan(OCAP)
•
Learn and determine product criteria
•
Perform electronics FOL basic operation of
equipment
•
Perform electronics FOL manual processes
•
...
FOL sample units
•
Identify usage and types of electronics FOL sample
units according to product criteria
•
Lecture
•
Discussion
...
Use appropriate tools
•
Perform/Practice procedure in loading and
processing electronics FOL sample units
•
Practice manual electronics FOL process based on
instruction and company procedures
•
Learn and identify machines alarms/errors
•
Determine applicable out-of-control action
plan(OCAP) for electronics FOL
...
2.4 Load electronics
FOL production
units
•
Identify/Determine electronics FOL operations
process controls
•
Study and learn product orientation and
specifications
•
Identify usage of appropriate PPE and ESD
apparels
•
Use appropriate tools
•
...
•
Determine applicable out-of-control action
plan(OCAP) on electronics FOL operations
•
Verify product criteria
•
Perform visual/ mechanical inspection
•
Accomplish electronics FOL production line
documents
•
Lecture
•
...
operation
•
Check output and yield requirement
•
...
Perform visual/ mechanical inspection
•
Detect/Determine abnormality or non-conformance
•
Accomplish required production forms
•
Check completeness and accuracy of information
on electronics FOL production form for unusual
machine operation
•
Lecture
•
...
3.2 Perform visual
inspection
• Use appropriate inspection tools
• Identify types of electronics FOL product defects
• Apply finished products judgment criteria on
electronics FOL processes
• Check/Inspect products using appropriate
instruments/tools
• Perform procedures on identification and
segregation of non-conforming products in
electronics FOL operation
•
Apply 5S principles/ housekeeping procedures
• Perform visual inspection
•
...
3.4.1 Recommended list of tools, equipment and materials for the training of 25
trainees for Electronics FOL Operations NC II
...
Electronics Front-of-Line Operations NC II

• Must be a holder of Electronics Front-of-Line Operations NC II
...
4.1.1. To attain the National Qualification of either Electronics Front-of-Line (FOL)
Operations NC II, the candidate must demonstrate in all the units listed in Section
1. Successful candidates shall be awarded a National Certificate II signed by the
TESDA Director General.

4.1.2. The qualification of Electronics Front-of-Line (FOL) Operations NC II can be
attained through demonstration of competence through project-type assessment
...
tool to help the candidate and the assessor determine what evidence is
...
additional information or skills that should be gained prior assessment
...
meaning individual blocks of data can be stored or retrieved in any order rather
than sequentially. An HDD consists of one or more rigid ("hard") rapidly rotating disks
(platters) with magnetic heads arranged on a moving actuator arm to read and write
...
outlines information and procedures for handling and working with chemicals. Current
MSDS documents contain physical and chemical property information, potential hazard
information, emergency procedures, and manufacturer contact information. MSDS
...
out-of-control situations. It consists of activators (which define out-of-control conditions);
checkpoints (which are likely causes for the conditions); and terminators (which contain
the action that should resolve the conditions). OCAPs are dynamic. For example,
Pareto analyses of OCAPs can identify commonly used terminators and suggests
methods to eliminate frequent causes of problems or to modify the OCAPs that react to
common out-of-control situations. Benefits of OCAPs include the empowerment given
to the operators to troubleshoot problems. Other benefits are increased process
efficiency and standardization of problem solving techniques.
...
establishment whereby materials are put through a process to produce an end-product.
The machines and peripheral equipment are in the order they are used. The process is
not stopped and restarted for each new product as the line is dedicated to producing a
single or small group of products.

13) Quality management system (QMS) - is a collection of business processes focused
on achieving your quality policy and quality objectives — i.e. what your customer wants
and needs. It is expressed as the organizational structure, policies, procedures,
...
Monitor Front-of-Line
(FOL) Operations for
Electronics Production
Line
Check quality
compliance of Front-of-
Line (FOL) operations
for electronics
production line
Set up Back-end
...
Luz Victoria G. Amponin
TESDA
lvgamponin@tesda.gov.ph
Zoilo C. Galang
TESDA
zl_g2002@yahoo.com
Julford C. Abasolo
