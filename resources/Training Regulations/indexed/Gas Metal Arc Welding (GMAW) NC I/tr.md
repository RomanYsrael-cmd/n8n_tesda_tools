...
- Source file: `Gas Metal Arc Welding (GMAW) NC I.pdf`
- SHA-256: `d5c40ee0065e32d273f67902c2ae1cd48ad3125097fae088e02421e1a9ca1fff`
- PDF pages: 59
- Lifecycle: unclear
...
SECTION 1 GAS METAL ARC WELDING (GMAW) NC I
QUALIFICATION
2
...
GAS METAL ARC WELDING (GMAW) NCI

SECTION 1 GAS METAL ARC WELDING (GMAW) NCI

The Gas Metal Arc Welding (GMAW) NC I Qualification consists of
competencies that a person must achieve to weld carbon steel plates components
as specified by layout, blueprints, diagrams, work order, welding procedure or oral
...
required in GAS METAL ARC WELDING (GMAW) NC I.
...
required in welding carbon steel plates using
GMAW process.
...
1.3 Weld is visually checked for defects and repaired, as
 required
1.4 Weld is visually acceptable in accordance with applicable
codes and standards
2. Clean root pass
...
3.2 Weld is visually checked for defects and repaired, as
 required
3.3 Weld is visually acceptable in accordance with applicable
codes and standards
4. Perform capping
...
4.2 Weld is visually checked for defects and repaired, as
 required
4.3 Weld is visually acceptable in accordance with applicable
codes and standards
...
1.8.1 Gen-set
1.8.2 Rectifier transformer Type
1.8.2 Wire feeder
...
2.6 Degree of reinforcement
2.7 Burn Through
2.8 Crater cracks
2.9 Cracks
2.10 Lack of Fusion (tie-in)
2.11 Pinholes/Blowholes
2.12 Under Fill
2.13 Overlap
2.14 Misalignment
2.15 Distortion
...
competency
Assessment requires evidence that the candidate
welded carbon steel plates using GMAW process in
2G and 3G positions to acceptable standard
...
2.3 Welding Equipment and Tools
 2.3.1 GMAW mode of metal transfer
...
3.6 Handling materials and consumables
4
...
•
Must be a holder of GMAW Welder NC I
•
...
4.1
To attain the National Qualification of GMAW I, the candidate must
