...
- Source file: `Semiconductor Front-of-Line Operation NC II.pdf`
- SHA-256: `70ac05246ea1ad99991d2ff5a4b65aae0b20bf4342197316c1936ae959882889`
- PDF pages: 71
- Lifecycle: unclear
...
SEMICONDUCTOR FRONT-OF-LINE
(FOL) OPERATIONS NC II
...
ELECTRICAL & ELECTRONICS SECTOR
SEMICONDUCTOR FRONT-OF-LINE (FOL) OPERATIONS
NATIONAL CERTIFICATE LEVEL II

Page No.
SECTION 1
SEMICONDUCTOR FOL OPERATIONS
...
TR-Semiconductor Front-of-Line Operations NC II (NEW) Promulgated Dec. 16, 2015
1
TRAINING REGULATIONS FOR
SEMICONDUCTOR FRONT-OF-LINE (FOL) OPERATIONS NC II

Section 1
SEMICONDUCTOR FOL OPERATIONS NC II QUALIFICATIONS

The Semiconductor Front-of-Line (FOL) Operations NC II Qualification consists of
competencies that must be possessed to enable a person to work in a semiconductor
company engaged in production of semiconductor front-of-line products. This qualification
involves such competencies to set up the FOL operations workplace, analyze, carry-out and
monitor FOL operations and check quality compliance of FOL operations for semiconductor
production line.
...
CORE COMPETENCIES
ELC313310
Setup front-of-line (FOL) operations workplace for semiconductor
production line
ELC313311
...
•
Semiconductor Front-of-Line Operator
...
competency required for Semiconductor Front-of-Line (FOL) Operations NC II.
...
using tools are observed
at all times and
appropriate personal
protective equipment
(PPE) are used
3.3 Malfunctions, unplanned
...
2.1 Observation with oral questioning
...
UNIT OF COMPETENCY: SET UP FRONT-OF-LINE (FOL) OPERATIONS WORKPLACE
FOR SEMICONDUCTOR PRODUCTION LINE

UNIT CODE : ELC313310

UNIT DESCRIPTOR : This unit covers the knowledge, skills and attitudes needed in setting up
the front-of-line (FOL) operation workplace for semiconductor production
line. This includes gathering production tools and materials, setting up
semiconductor FOL machine parameters and peripherals,
accomplishing production line checklist and performing daily
...
line checklist are correctly
filled-out according to
specifications
3.3 Semiconductor production
line checklist is completed
based on required time
3.4 Work turnover procedure
is performed for next work
shift
...
RANGE
1. Materials
Semiconductor materials may include:
1.1
wafer
1.2
Cassette
...
Wire bonded units
1.10 Molded Units
1.11 Molding compounds
1.12 Trays/ tube
1.13 Applicable Chemicals
...
RANGE
5. Processes
Semiconductor front-of-line processes may include
...
7.1.2 PM checklist
7.1.3 Monitoring checklist
7.1.4 SPC checklist
7.1.5 Production log sheet
7.2
...
physical
 conditions
May include:
10.1 Complete screws (for accessible parts only)
10.2 Fan is working
10.3 No oil leakage
10.4 No broken wire
10.5 Free from foreign materials
10.6 Industrial PC in good condition
10.7 Dust free
...
Assessment requires evidence that the candidate:
1.1
Gathered production tools and materials semiconductor front-
of-line operation according to approved production
specifications
1.2
Checked and set up semiconductor front-of-line machine
parameters and peripherals for production startup and usage
1.3
Accomplished semiconductor front-of-line production quality
...
The following resources MUST be provided:
2.1
Appropriate semiconductor FOL machine and equipment
2.2
...
(FOL) OPERATIONS FOR SEMICONDUCTOR PRODUCTION
LINE
...
line (FOL) operation for semiconductor production line. This
includes initializing/operating semiconductor FOL equipment,
running sample units and loading production units. It also includes
performing FOL manual processes, if applicable.
...
(ESD), Environmental Health
Systems (EHS),
Occupational Health and
Safety (OHS)
• Understanding
semiconductors production
line FOL product and
process specification
• Operation of semiconductors
production line FOL
machines
• Basic semiconductors FOL
machines/ equipment
troubles/ breakdowns
...
production line FOL sample
units
• Product orientation
• Understanding of OCAP on
running semiconductors
production line FOL sample
units
• Completeness and accuracy
of information on production
line FOL form for sample
units
• Reading skills
• Observation
Skills
...
product criteria
3.2 Production units are
loaded to the equipment
in accordance to product
orientation and
specifications
...
conformance or deviation
to the process
3.5 Semiconductors FOL
production forms are
accomplished based on
production procedures

• Semiconductors production
line FOL operation process
controls
• Understanding of OCAP on
semiconductors production
line FOL operation
...
4 Semiconductor FOL
machines
Semiconductor FOL Machines may include:
4.1 Wafer Saw Machine
4.2 Die Bond Machine
4.3 Wire Bond Machine
4.4 Molding Machines
4.5 DTFS machines
5 Semiconductor FOL
processes
Semiconductor FOL processes may include:
5.1 Wafer back grinding
5.2 Wafer testing
5.3 Die Cutting
5.4 Die Attached
5.5 Wire bonding
...
Assessment requires evidence that the candidate:
1.1
Operated semiconductor front-of-line machine/ equipment
according to production requirements
1.2
Run semiconductor front-of-line sample units in
accordance to product orientation and specifications
1.3
Loaded semiconductor front-of-line production units in
accordance to product orientation and specifications
2. Resource
Implications
The following resources MUST be provided:
...
TR-Semiconductor Front-of-Line Operations NC II (NEW) Promulgated Dec. 16, 2015
37
UNIT OF COMPETENCY: CHECK QUALITY COMPLIANCE OF FRONT-OF-LINE (FOL)
 OPERATIONS FOR SEMICONDUCTOR PRODUCTION LINE

UNIT CODE : ELC313312

UNIT DESCRIPTOR : This unit covers the knowledge, skills and attitudes needed in
performing front-of-line (FOL) operation for semiconductor
production line. This includes monitoring front-end
machine/equipment operation, completing lot traceability and
performing visual machine inspection.
...
5.3 Die crack
5.4 Wafer scratch
5.5 Presence of foreign materials
5.6 lead defects
5.7 mold defects
...
Assessment requires evidence that the candidate:
1.1
Monitored semiconductor front-of-line operation based on
product requirements
1.2
Completed semiconductor front-of-line lot traceability in
...
when designing training programs for Semiconductor Front-of-Line (FOL) Operations NC II.
...
Course Title: Semiconductor Front-of-Line Operations
NC Level: NC II
...
Semiconductor FOL Operator, in accordance with industry standards. It covers the basic &
common competencies in addition to the core competencies such as preparing workplace,
analyzing, carrying-out and monitoring front-of-line machine/equipment operations and
checking quality compliance for semiconductor production line.

To obtain this, all units prescribed for this qualification must be achieved.

--- PDF PAGE 45 ---
TR-SEMICONDACTOR FRONT-OF-LINE OPERATIONS NC II (NEW) PROMULGATED DEC. 16, 2015
41
BASIC COMPETENCIES
(16 hours)
...
semiconductor
FOL operation
• Identify/determine semiconductor FOL manufacturing
processes
...
semiconductor FOL machine
•
Set/Check required semiconductor FOL machine
parameters
• Discuss and demonstrate procedures in set up of
semiconductor FOL machine parameters and
peripherals
• Lecture
• Discussion
• Demonstration
...
Duration
•
Study types and functions of semiconductor FOL
...
maintenance
activity
• Identify and check semiconductor FOL machine basic
physical condition
...
manual
•
Learn and interpret overview of semiconductor FOL
processes
•
Identify types of semiconductor FOL sample units
•
...
sample units
•
Perform manual semiconductor FOL processes
• Lecture
• Discussion
• Hands-on
• Demonstration
...
Duration
•
Identify semiconductor FOL equipment troubles/
problems
•
...
units
•
Identify usage and types of semiconductor FOL
...
units
•
Identify/Determine semiconductor FOL operations
process controls
•
...
•
Determine applicable out-of-control action
plan(OCAP) on semiconductor FOL operations
•
Verify product criteria
•
Perform visual/ mechanical inspection
•
Accomplish semiconductor FOL production line
documents
3. Check quality
compliance of
FOL operations
...
semiconductor FOL production form for unusual
machine operation
• Lecture
• Discussion
• Hands-on
...
25 trainees for Semiconductor Front-of-Line Operations NC II
...
• Must be a holder of Semiconductor FOL Operations NC II
...
4.1.1. To attain the National Qualification of Semiconductor Front-of-Line (FOL)
...
4.1.2. The qualification of Semiconductor Front-of-Line (FOL) Operations NC II can
be attained through demonstration of competence through project-type
...
MSDS documents contain physical and chemical property information, potential
hazard information, emergency procedures, and manufacturer contact information.
MSDS formats can vary from source to source within a country depending on national
requirements.
